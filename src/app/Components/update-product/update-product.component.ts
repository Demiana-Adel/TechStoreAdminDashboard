...
export class UpdateProductComponent implements OnInit {
  ...
  getOneProduct() {
    this._productService.grtOneProduct(this.productId).subscribe((result: IProductDetails) => {
      ...
      this._categoryservice.getCategorySpecific(this.CategoryId).subscribe((response: any) => {
        ...
        result.entity.specificationsNameValueDtos.forEach(spec => {
          ...
          const matchingEntity = response.entities.find((entity: { name: string; id: any }) => entity.name === spec.name);
          if (matchingEntity) {
  ...
  updateProduct() {
    this.formData.append('Id', this.newProduct.CreateOrUpdateProductDtos.Id?.toString());
    this.formData.append('Ar_Description', this.newProduct.CreateOrUpdateProductDtos.Ar_Description?.toString()||'');
    this.formData.append('Ar_ModelName', this.newProduct.CreateOrUpdateProductDtos.Ar_ModelName?.toString()||'');
    this.formData.append('Description', this.newProduct.CreateOrUpdateProductDtos.Description);
    this.formData.append('UserId', this.newProduct.CreateOrUpdateProductDtos.UserId?.toString() || '');
    this.formData.append('DiscountedPrice', this.newProduct.CreateOrUpdateProductDtos.DiscountedPrice?.toString() || '');
    this.formData.append('Brand', this.newProduct.CreateOrUpdateProductDtos.Brand);
    this.formData.append('ModelName', this.newProduct.CreateOrUpdateProductDtos.ModelName);
    this.formData.append('DiscountValue', this.newProduct.CreateOrUpdateProductDtos.DiscountValue?.toString() || '');
    this.formData.append('DiscountedPrice', this.newProduct.CreateOrUpdateProductDtos.DiscountedPrice?.toString() || '');
    this.formData.append('Price', this.newProduct.CreateOrUpdateProductDtos.Price.toString());
    this.formData.append('Quantity', this.newProduct.CreateOrUpdateProductDtos.Quantity?.toString() || '');
    this.formData.append('Warranty', this.newProduct.CreateOrUpdateProductDtos.Warranty?.toString() || '');
    this.formData.append('CategoryId', this.newProduct.CreateOrUpdateProductDtos.CategoryId.toString());
    this.newProduct.ProductCategorySpecifications.forEach((specification, index) => {
      this.formData.append(`ProductCategorySpecifications[${index}].Id`, specification.Id?.toString() || '');
      this.formData.append(`ProductCategorySpecifications[${index}].ProductId`, specification.ProductId?.toString() || '');
      this.formData.append(`ProductCategorySpecifications[${index}].CategoryId`, specification.CategoryId?.toString() || '');
      this.formData.append(`ProductCategorySpecifications[${index}].SpecificationId`, specification.SpecificationId?.toString() || '');
      this.formData.append(`ProductCategorySpecifications[${index}].Value`, specification.Value);
    });
  ...
  updateSpecificationValue(specific: any, newval: any) {
    const existingSpecification = this.newProduct.ProductCategorySpecifications.find((spec: any) => spec.SpecificationId === specific.id);
